              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <form action="{{route('branches.update',$branch->id)}}" method="post" enctype="multipart/form-data" id="fo1">
                              @csrf
                              ...
                              <div class="form-group">
                                    ...
                                    <select id="gouvern_id" name="gouverne_id" class="form-control col-4" style="border-radius:20px">
                                      ...
                                      @if ($gouverne->id == $branch->gouverne_id)
                                      selected
                                      @endif
                                      value="{{ $gouverne->id }}">
                                 ...
                                 <div id="district_div" class="form-group">
                                  ...
                                  <select  id="district_dd" name="district_id" class="form-control col-4" style="border-radius:20px">
                                    ...
                                    @if ($district->id == $branch->district_id)
                                    selected
                                    @endif
                                    value="{{ $district->id }}">
