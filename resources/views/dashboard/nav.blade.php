                  ...
                  <li class="dropdown dropdown-user nav-item">
                    <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                      <span class="mr-1">Hello,
                        <span class="user-name text-bold-700"> @if(auth()->user()){{auth()->user()->name }}@endif</span>
                      </span>
                      <span class="avatar avatar-online">
                        <img src="{{asset("admin/app-assets/images/portrait/small/avatar-s-19.png")}}" alt="avatar"><i></i></span>
                    </a>
                    
                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('myAccount.edit',auth()->user()->id)}}"><i class="ft-user"></i> Edit Profile</a>
